...
assert.match(backendSurface, /Do not recommend bypassing an interlock/);
assert.match(backendSurface, /returning equipment to service from image evidence alone/);
