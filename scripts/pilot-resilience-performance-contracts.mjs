...
mustMatch(performance, /premium card geometry adds less than 1 KiB of CSS/, "The premium card CSS allowance must remain explicitly bounded and reviewed");
mustMatch(performance, /without relaxing JavaScript or total-dist limits/, "The premium card allowance must not loosen JavaScript or total distribution ceilings");
