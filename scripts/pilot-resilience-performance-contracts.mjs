...
mustMatch(performance, /VOR-095 adds only the measured shared navy background CSS/, "The VOR-095 CSS allowance must remain limited to the reviewed shared background treatment");
