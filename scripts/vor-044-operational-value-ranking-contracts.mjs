...
assert.match(healthGate, /reviewedAuthenticatedReadRpcCount\),\s*55/);
assert.match(healthGate, /const reviewedRpcCount/);
assert.match(healthGate, /const callableRpcCount/);
assert.match(healthGate, /callableRpcCount,\s*reviewedRpcCount/);
assert.match(healthGate, /anonymousVortaRpcCount/);
assert.match(healthGate, /rpcSecurityManifestDriftCount/);
