...
const checks = [
  ...
  [integrationScript.includes('sitePriorityPageExclusion') && integrationScript.includes('site_threat_prioritization') && integrationScript.includes('shift-cover'), "Shift Cover page context outranks the broad site-priority route"],
