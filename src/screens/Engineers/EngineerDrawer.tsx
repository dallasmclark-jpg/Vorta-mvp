...
export function EngineerDrawer({ engineer, assignments, trainingBookings, skillGaps, onClose }: DrawerProps) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-y-0 right-0 z-50 flex w-full flex-col border-l border-gray-800 bg-[#0d1117] shadow-2xl transition-transform duration-300 ease-in-out sm:max-w-[480px] ${
