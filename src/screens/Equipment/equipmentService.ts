...
const MOCK_EQUIPMENT: Equipment[] = [
  ...
  },
  {
    ...
    image: EQUIPMENT_IMAGES.fillingLine,
    riskScore: 92,
    riskLevel: "Critical",
    riskBreakdown: [
...
function rowToEquipment(row: EquipmentAssetRow): Equipment {
  ...
  return {
    ...
    statusNote:   "",
    image:        row.image_url || EQUIPMENT_IMAGES.palletiser,
    riskScore,
    riskLevel,
