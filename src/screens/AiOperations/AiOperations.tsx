...
const TrainingSection = lazy(() => import("../Training").then((module) => ({ default: module.TrainingSection })));
const TrainingProvidersSection = lazy(() => import("../TrainingProviders").then((module) => ({ default: module.TrainingProvidersSection })));
const AiMatchingSection = lazy(() => import("../AiMatching").then((module) => ({ default: module.AiMatchingSection })));
const SettingsSection = lazy(() => import("../Settings").then((module) => ({ default: module.SettingsSection })));
const SupportSection = lazy(() => import("../Support").then((module) => ({ default: module.SupportSection })));
const SapDataImportSection = lazy(() => import("../DataImport").then((module) => ({ default: module.SapDataImportSection })));
const DesignSystemSection = lazy(() => import("../DesignSystem").then((module) => ({ default: module.DesignSystemSection })));
const CareerSection = lazy(() => import("../Career").then((module) => ({ default: module.CareerSection })));
const PilotAdoptionSection = lazy(() => import("../PilotAdoption/PilotAdoptionSection").then((module) => ({ default: module.PilotAdoptionSection })));
const PilotImpactSection = lazy(() => import("../PilotImpact/PilotImpactSection").then((module) => ({ default: module.PilotImpactSection })));
const PilotSetupSection = lazy(() => import("../PilotSetup/PilotSetupSection").then((module) => ({ default: module.PilotSetupSection })));
...
const EquipmentNotifications = lazy(() => import("../Equipment").then((module) => ({ default: module.EquipmentNotifications })));
const EquipmentWorkOrders = lazy(() => import("../Equipment").then((module) => ({ default: module.EquipmentWorkOrders })));
const EquipmentPMs = lazy(() => import("../Equipment").then((module) => ({ default: module.EquipmentPMs })));
const EquipmentHistory = lazy(() => import("../Equipment").then((module) => ({ default: module.EquipmentHistory })));
const EquipmentSkills = lazy(() => import("../Equipment").then((module) => ({ default: module.EquipmentSkills })));
const EquipmentSpares = lazy(() => import("../Equipment").then((module) => ({ default: module.EquipmentSpares })));
const EquipmentDocuments = lazy(() => import("../Equipment").then((module) => ({ default: module.EquipmentDocuments })));
const EquipmentDocumentViewer = lazy(() => import("../Equipment").then((module) => ({ default: module.EquipmentDocumentViewer })));
const EquipmentAiInsights = lazy(() => import("../Equipment").then((module) => ({ default: module.EquipmentAiInsights })));
...
function RouteLoader(): JSX.Element {
  return (
    <section className="flex min-h-[50vh] items-center justify-center" role="status" aria-live="polite">
...
export const AiOperations = (): JSX.Element => {
  ...
  const secondaryNav = [
    {
      label: isLivePilotMode ? "Support Evidence" : "Support",
      icon: Headphones,
      to: "/support",
    },
    ...(mayAdministerPilot
    ...
    ...(mayImportSapData
      ...
      : []),
    {
      label: isLivePilotMode ? "System & Access" : "Settings",
      icon: Cog,
      to: "/settings",
      end: true,
    },
