...
export const AiOperations = (): JSX.Element => (
  ...
  >
    <Routes>
      ...
      />
      <Route
        path="equipment/:equipmentId/health"
        element={<EquipmentHealth />}
      />
      <Route
      ...
      <Route
        ...
        element={<EquipmentSkills />}
      />
      <Route
        path="equipment/:equipmentId/spares"
        element={<EquipmentSpares />}
      />
      <Route
